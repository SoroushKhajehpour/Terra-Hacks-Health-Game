...
window.addEventListener('DOMContentLoaded', async function() {
    console.log('Page loaded - Menu screen active');
    
    // Setup start button to initialize camera when clicked
    const startButton = document.getElementById('startButton');
    if (startButton) {
        startButton.addEventListener('click', async function() {
            console.log('Starting game - Initializing camera and pose detection...');
            ...
            if (mainMenu && gameContainer) {
                ...
                // Initialize the camera and pose detection after game starts
